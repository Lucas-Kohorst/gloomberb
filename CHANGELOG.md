...
- **Adjacent Cloud** — Adjacent, VoteHub polls, Weather Company settlements, and Artificial Analysis live in one Data plugin. Hosted GETs are edge-cached so every user shares one origin pull. RSS stays on News.
