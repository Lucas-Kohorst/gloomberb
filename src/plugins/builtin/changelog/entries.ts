...
- Chat presence dots follow the live user list from presence snapshots and websocket payloads, not just the online count.
...
- Click a chat username, a member chip, or empty-composer \`p\` in a DM for the public profile. \`WHO\` only lists public profiles. Green presence dots use the live presence user list, including nested websocket payloads.
