...
const EDITORIAL: Record<string, { categories: string[]; featured?: true }> = {
  ...
  satellite: { categories: ["data"] },
  simplefin: { categories: ["broker"] },
  "space-weather": { categories: ["data"] },
  "ticker-research": { categories: ["research"] },
  traffic: { categories: ["data"] },
  usaspending: { categories: ["data", "research"] },
  "usgs-earthquakes": { categories: ["data"] },
