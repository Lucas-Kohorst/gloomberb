...
import type { LightweightChartProps } from "../../../../ui/host";
import {
...
function createSeries(
  ...
  type: TradingViewSeriesType,
  colors: LightweightChartProps["colors"],
...
export const LIGHTWEIGHT_TIME_AXIS_FOOTER_GAP_PX = 12;

export function WebLightweightChart({
  panel,
  seriesData,
  colors,
  viewport,
  ...
  return (
    <div
      ...
      {...pointerHandlers}
      ref={wrapperRef}
      data-gloom-chart-engine="lightweight"
      style={{
        position: "relative",
        display: "flex",
        ...
        paddingBottom: LIGHTWEIGHT_TIME_AXIS_FOOTER_GAP_PX,
      }}
    >
      <div
        ref={containerRef}
        data-gloom-role="lightweight-chart-canvas"
      ...
      <svg
        ...
        style={{
          ...
          left: 0,
          right: 0,
          bottom: LIGHTWEIGHT_TIME_AXIS_FOOTER_GAP_PX,
          width: "auto",
          height: "auto",
          pointerEvents: "none",
          zIndex: 1,
