...
const CAPABILITIES: Record<string, PaneFunctionCapability> = {
  ...
  "correlation-pane": {
    ...
    intents: ["compare correlations between security and prediction-market returns"],
    outputKind: "correlation-matrix",
    reportReadiness: "ready",
    screenshotReadiness: "partial",
    dataRequirements: ["date-aligned price or prediction-market history"],
    limitations: ["Correlation is computed from daily returns of equity closes, prediction-market yes-prices, and Adjacent index levels, with at least five shared observations."],
    options: [{
      key: "rangePreset",
